...
)
{
    ...
    default:
        if (sys_midi)
        {
            ...
            #else
            printf("System MIDI not supported on this platform !!\n");
            SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_ERROR,
                "Raptor", "System MIDI not supported on this platform !!", NULL);
            EXIT_Error("System MIDI not supported on this platform !!");
            #endif // _WIN32 __linux__ __ANDROID__ __APPLE__
        }
        else
