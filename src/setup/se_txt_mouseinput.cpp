...
static void GetMouseButtonDescription(int button, char* buf, size_t buf_len)
{
    ...
    {
    case 0:
        M_StringCopy(buf, "LEFT BUTTON", buf_len);
        break;
    case 1:
        M_StringCopy(buf, "RIGHT BUTTON", buf_len);
        break;
    case 2:
        M_StringCopy(buf, "MID BUTTON", buf_len);
        break;
    default:
...
txt_mouse_input_t* TXT_NewMouseInput(int* variable)
{
    ...
    mouse_input = (txt_mouse_input_t *) malloc(sizeof(txt_mouse_input_t));
